...
"""
#Menu
def level(BASE_DIR): #this is not in use because icba to fix it rn
    #ESSENTIAL CODE DO NOT TOUCH
    SCREEN_WIDTH = 1280
    SCREEN_HEIGHT = 720
    global background_image1
...
def game1():
    ...
    class Space(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load(os.path.join(BASE_DIR, "Sprites", "Other", "Background.png")).convert(),
                (960, 3163))
            self.surf.set_colorkey((0, 255, 255), RLEACCEL)
            self.rect = self.surf.get_rect()
            self.rect.left = (325)
        ...
        def update(self):
            ...
            if space.rect.top == (SCREEN_HEIGHT):
                space.rect.bottom == (0)
...
def next_level(BASE_DIR):
    ...
    sprite_timer = 100
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) 
    background_image1 = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "Sprites", "Other", "Level Select", "next_level-1.png.png")), (1280, 720))
    menu_in_use = 1
    details_sent = False

    if score0 == 10 or score0 == 530 or score0 == 1570 or score0 == 3670: #level 1
    ...
    elif score0 == 0 or score0 == 510 or score0 == 1530 or score0 == 3570: #level 0/7 boss
