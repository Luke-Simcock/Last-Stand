...
def leaderboard(BASE_DIR):
    ...
    while running:
        ...
        #Cirtical Screen Stuff
        screen.blit(Menu1.surf, Menu1.rect)
        screen.blit(name1_printed, (710, 187))        
        screen.blit(score1_printed, (900, 187))        
        screen.blit(name2_printed, (710, 267))        
        screen.blit(score2_printed, (900, 267))        
        screen.blit(name3_printed, (710, 347))        
        screen.blit(score3_printed, (900, 347))        
        screen.blit(name4_printed, (710, 427))        
        screen.blit(score4_printed, (900, 427))        
        screen.blit(name5_printed, (710, 507))        
        screen.blit(score5_printed, (900, 507))        
        pygame.display.flip()
        clock.tick(10)
