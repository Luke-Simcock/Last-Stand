...
def game():
    ...
    class Player(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load("C:/Sprites/Player/Frame1.png").convert_alpha(),
        ...
        def update(self, pressed_keys):
            ...
            if sprite_timer == 80:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Frame2.png").convert_alpha(),
                    (player_size_w, player_size_h))
            
            if sprite_timer == 60:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Frame3.png").convert_alpha(),
                    (player_size_w, player_size_h))
            
            if sprite_timer == 40:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Frame4.png").convert_alpha(),
                    (player_size_w, player_size_h))

            if sprite_timer == 20:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Frame5.png").convert_alpha(),
                    (player_size_w, player_size_h))
    ...
    class Bullet(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load("C:/Sprites/Player/Weapons/SetAs'00FFFF'.png").convert_alpha(),
        ...
        def update(self):
            ...
            if sprite_timer == 100:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Weapons/Bullet/Frame1.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))

            if sprite_timer == 80:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Weapons/Bullet/Frame2.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))

            if sprite_timer == 60:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Weapons/Bullet/Frame3.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))

            if sprite_timer == 40:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Weapons/Bullet/Frame4.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))

            if sprite_timer == 20:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Player/Weapons/Bullet/Frame5.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))
    ...
    class Missile(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if missile_shot == True:
                ...
                if sprite_timer == 100:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Missiles/Frame1.png").convert_alpha(),
                        (missile_size_w, missile_size_h))

                if sprite_timer == 80:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Missiles/Frame2.png").convert_alpha(),
                        (missile_size_w, missile_size_h))

                if sprite_timer == 60:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Missiles/Frame3.png").convert_alpha(),
                        (missile_size_w, missile_size_h))

                if sprite_timer == 40:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Missiles/Frame4.png").convert_alpha(),
                        (missile_size_w, missile_size_h))

                if sprite_timer == 20:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Missiles/Frame5.png").convert_alpha(),
                        (missile_size_w, missile_size_h))
    ...
    class Bomb(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if bomb_shot == True:
                ...
                if sprite_timer == 100:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Bombs/Frame1.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 80:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Bombs/Frame2.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 60:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Bombs/Frame3.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 40:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Bombs/Frame4.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 20:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Player/Weapons/Bombs/Frame5.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
    ...
    class Enemy1(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load("C:/Sprites/Enemies/Level 1/1/Frame1.png").convert_alpha(),
        ...
        def update(self):
            ...
            if sprite_timer == 75:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Level 1/1/Frame2.png").convert_alpha(),
                    (enemy_size_w1, enemy_size_h1))
                
            
            if sprite_timer == 50:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Level 1/1/Frame3.png").convert_alpha(),
                    (enemy_size_w1, enemy_size_h1))
                
            
            if sprite_timer == 25:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Level 1/1/Frame4.png").convert_alpha(),
                    (enemy_size_w1, enemy_size_h1))
    ...
    class Enemy_Bullet1(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if sprite_timer == 100:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Weapons/Bullet/Frame1.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))
                

            if sprite_timer == 80:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Weapons/Bullet/Frame2.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))
                

            if sprite_timer == 60:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Weapons/Bullet/Frame3.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))
                

            if sprite_timer == 40:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Weapons/Bullet/Frame4.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))
                

            if sprite_timer == 20:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Weapons/Bullet/Frame5.png").convert_alpha(),
                    (bullet_size_w, bullet_size_h))
    ...
    class Enemy_Missile1(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if enemy1_missile_shot == True:
                ...
                if sprite_timer == 100:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Missiles/Frame1.png").convert_alpha(),
                        (missile_size_w, missile_size_h))
                    

                if sprite_timer == 80:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Missiles/Frame2.png").convert_alpha(),
                        (missile_size_w, missile_size_h))
                    

                if sprite_timer == 60:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Missiles/Frame3.png").convert_alpha(),
                        (missile_size_w, missile_size_h))
                    

                if sprite_timer == 40:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Missiles/Frame4.png").convert_alpha(),
                        (missile_size_w, missile_size_h))
                    

                if sprite_timer == 20:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Missiles/Frame5.png").convert_alpha(),
                        (missile_size_w, missile_size_h))
    ...
    class Enemy_Bomb1(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if enemy1_bomb_shot == True:
                ...
                if sprite_timer == 100:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Bombs/Frame1.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 80:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Bombs/Frame2.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 60:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Bombs/Frame3.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 40:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Bombs/Frame4.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
                    

                if sprite_timer == 20:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Sprites/Enemies/Weapons/Bombs/Frame5.png").convert_alpha(),
                        (bomb_size_w, bomb_size_h))
    ...
    class Enemy2(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load("C:/Sprites/Enemies/Level 1/2/Frame1.png").convert_alpha(),
        ...
        def update(self):
            ...
            if sprite_timer == 75:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Level 1/2/Frame2.png").convert_alpha(),
                    (enemy_size_w2, enemy_size_h2))
                
            
            if sprite_timer == 50:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Level 1/2/Frame3.png").convert_alpha(),
                    (enemy_size_w2, enemy_size_h2))
                
            
            if sprite_timer == 25:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Sprites/Enemies/Level 1/2/Frame4.png").convert_alpha(),
                    (enemy_size_w2, enemy_size_h2))
    ...
    while running:
        ...
        def enemy2_update():
            enemy2.update()
        def enemy2_weapons_update():
            enemy2_bullet1.update()
            enemy2_bullet2.update()
            enemy2_missile1.update()
            enemy2_bomb1.update()
        def timers_and_delays():
            global sprite_timer, enemy1_bullet_delay_time
            if sprite_timer == 0:
                sprite_timer = 100 
            else:
                sprite_timer -= 5
        ...
        def characters_damage_die():
            ...
            if pygame.sprite.spritecollideany(enemy3_bomb1, players):
                ...
                time.sleep(1.5)
                running = False
        def random_chance_enemies():
            global enemy1_bullet_chance
            global enemy1_missile_chance
            global enemy1_bomb_chance
            global enemy2_bullet_chance
            global enemy2_missile_chance
            global enemy2_bomb_chance
            global enemy3_bullet_chance
            global enemy3_missile_chance
            global enemy3_bomb_chance
        ...
        Thread1 = threading.Thread(target=pressed_keys_player, args=("pressed_keys",))
        Thread2 = threading.Thread(target=player_weapons_update)
        Thread3 = threading.Thread(target=enemy1_update)
        Thread4 = threading.Thread(target=enemy1_weapons_update)
        Thread5 = threading.Thread(target=enemy2_update)
        Thread6 = threading.Thread(target=enemy2_weapons_update)
        Thread7 = threading.Thread(target=timers_and_delays)
        Thread8 = threading.Thread(target=weapon_despawns)
        Thread9 = threading.Thread(target=characters_damage_die)
        Thread10 = threading.Thread(target=random_chance_enemies)
        Thread11 = threading.Thread(target=random_chance_enemies_is5)
        ...
        for entity in all_sprites:
            ...
            screen.blit(enemy1.surf, enemy3.rect)
        pygame.display.flip()
        clock.tick(hz)
