...
menu_choice = ""
settings_choice = ""
background_image = pygame.image.load('C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Other/Background.png')
...
def game():
    ...
    windll.user32.MoveWindow(hwnd, 502, 0, SCREEN_WIDTH, SCREEN_HEIGHT, True)
    ...
    class Player(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Frame1.png").convert(),
        ...
        def update(self, pressed_keys):
            ...
            if sprite_timer == 80:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Frame2.png").convert(),
                    (player_size_w, player_size_h))
                self.surf.set_colorkey((0, 255, 255), RLEACCEL)
            
            if sprite_timer == 60:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Frame3.png").convert(),
                    (player_size_w, player_size_h))
                self.surf.set_colorkey((0, 255, 255), RLEACCEL)
            
            if sprite_timer == 40:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Frame4.png").convert(),
                    (player_size_w, player_size_h))
                self.surf.set_colorkey((0, 255, 255), RLEACCEL)

            if sprite_timer == 20:
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Frame5.png").convert(),
                    (player_size_w, player_size_h))
                self.surf.set_colorkey((0, 255, 255), RLEACCEL)
    ...
    class Missile(pygame.sprite.Sprite):
        ...
        def __init__(self):
            ...
            self.surf = pygame.transform.scale(
                pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Weapons/SetAs.png").convert(),
        ...
        def update(self):
            ...
            if missile_shot == False:
                ...
                self.surf = pygame.transform.scale(
                    pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Weapons/SetAs'00FFFF'.png").convert(),
                    (missile_size_w, missile_size_h))
                self.surf.set_colorkey((0, 255, 255), RLEACCEL)
    ...
    class Bomb(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            if bomb_shot == True:
                ...
                if sprite_timer == 80:
                    self.surf = pygame.transform.scale(
                        pygame.image.load("C:/Users/luke/OneDrive - Riverside College Halton/lessons/unit 4 (Ben)/5323/Sprites/Player/Weapons/Bombs/Frame2.png").convert(),
                        (bomb_size_w, bomb_size_h))
                    self.surf.set_colorkey((255, 255, 255), RLEACCEL)
