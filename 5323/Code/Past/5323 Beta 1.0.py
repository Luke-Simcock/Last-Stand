...
background_image = pygame.transform.scale(pygame.image.load(os.path.join(BASE_DIR, "Sprites", "Other", "Background1.png")), (1920, 1080))
...
def game():
    ...
    #Setting Up Sprites values
    WHITE = (255, 255, 255)
    sprite_gap_to_border = 75
    sprite_gap_to_right = 505
    sprite_gap_to_left = 485
    player_size_w = 90
    player_size_h = 144
    enemy_size_w = 72
    enemy_size_h = 56
